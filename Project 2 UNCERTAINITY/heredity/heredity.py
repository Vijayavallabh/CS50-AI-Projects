    ...
    for person in people:
        ...
        if people[person]['mother'] is None:
            ...
            if gene_number==0:
                ...
                probability*=(1-percentages[mother])*percentages[father]+(1-percentages[father])*percentages[mother]
            else:
...
def normalize(probabilities):
    ...
    for person in probabilities:
        for i in ['gene','trait']:
            total = sum(probabilities[person][i].values())
            for j in probabilities[person][i]:
                normalised = probabilities[person][i][j]/total
                probabilities[person][i][j] = normalised
